#encoding: utf-8
require '../bisseccao/bisseccao'

puts "Qual o grau da função que você deseja usar o Método da Bissecção?"
...
b = Bisseccao.new(inicio, fim, precisao, grau, coeficientes)
puts b.calcular_raiz
